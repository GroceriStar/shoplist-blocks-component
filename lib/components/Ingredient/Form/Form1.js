...
function (_Component) {
  ...
  _createClass(Form1, [{
    ...
    key: "handleSelect",
    value: function handleSelect(department) {
      this.setState({
    ...
    value: function render() {
      ...
      }, _react.default.createElement("label", null, "Input Ingredient name"), _react.default.createElement("br", null), _react.default.createElement("input", {
        type: "text",
        onChange: this.handleChange
      }), _react.default.createElement("br", null), _react.default.createElement(_Selectbox.default, {
        selectedValue: this.state.selectedDepartment,
        onSelect: this.handleSelect,
        data: (0, _selector.getDepartments)(true)
