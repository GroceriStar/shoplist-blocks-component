...
function (_Component) {
  ...
  function EditLink(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(EditLink).call(this, props));
    _this.state = {
  ...
  _createClass(EditLink, [{
    ...
    value: function render() {
      ...
      }, this.state.textLink), _react.default.createElement("input", {
        type: "text",
