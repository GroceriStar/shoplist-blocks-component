...
function (_Component) {
  ...
  function ListItemEdit() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ListItemEdit)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onclickItem", function (item) {
      _this.setState({
        hidenFields: false,
        inputText: item,
        currentItem: item
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onclickButton", function (e) {
      e.preventDefault();
