...
var DepartmentRouter =
/*#__PURE__*/
function (_Component) {
  _inherits(DepartmentRouter, _Component);

  function DepartmentRouter() {
    _classCallCheck(this, DepartmentRouter);

    return _possibleConstructorReturn(this, _getPrototypeOf(DepartmentRouter).apply(this, arguments));
  }

  _createClass(DepartmentRouter, [{
    key: "render",
